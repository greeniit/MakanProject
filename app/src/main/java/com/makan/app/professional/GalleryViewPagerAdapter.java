...
public class GalleryViewPagerAdapter extends PagerAdapter {
    ...
    private List<ProfessionalDetailsResponse.BannerGallery> bannerGalleries;




    public GalleryViewPagerAdapter(Context context,List<ProfessionalDetailsResponse.BannerGallery> bannerGalleries) {
        this.context = context;
        this.bannerGalleries=bannerGalleries;

    }

    @Override
    public int getCount() {
        return bannerGalleries.size();
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        tvPlaceName.setText(bannerGalleries.get(position).getImageTitle());

        Glide.with(context).load(WebConstant.BASE_IMAGE_URL+bannerGalleries.get(position).getAddsImg()).into(imageView);
