...
public class ProfessionalsSearchServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ClickListener clickListener;
    private ArrayList<ProfesionalServiceRespose.Service> profesionalServiceList;

    public ProfessionalsSearchServiceAdapter(Context mContext, ClickListener clickListener,ArrayList<ProfesionalServiceRespose.Service> profesionalServiceList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProfessionalsSearchServiceAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {

        ProfessionalsSearchServiceAdapter.ViewHolder viewHolder = (ProfessionalsSearchServiceAdapter.ViewHolder) holder;
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickListener.itemClicked(profesionalService.getServiceId());
